...
<div class="row">
    <div class="column1" style="background-color: black;">
        ...
        <th><a href="#"><img class="center" width=45% height=30%
                             src="${pageContext.request.contextPath}/resources/images/javabest.jpg"/></a></th>

        <form action="/signup" method="post">
        <h2 style="color: red"> java </h2>
        <div class="input-container">
            <i class="fa fa-user icon"></i>
            <input class="input-field" type="text" placeholder="Username" name="usrnm">
        </div>
        <div class="input-container">
            <i style="color: yellow" class="fa fa-key icon"></i>
            <input class="input-field" type="password" placeholder="Password" name="psw">
        </div>
        <div class="input-container">
            <i style="color: yellow" class="fa fa-phone icon"></i>
            <input class="input-field" type="phone" placeholder="Phone" name="phone">
        </div>
        <div class="input-container">
            <i style="color: yellow" class="fa fa-envelope icon"></i>
            <input class="input-field" type="email" placeholder="Email" name="email">
        </div>
        <div class="input-container">
            <i style="color: yellow" class=" fa fa-globe icon"></i>
